...
test-release-archive: compiler ae stdlib
	...
	for dir in runtime runtime/actors runtime/scheduler runtime/utils \
	           ...
	           std/config std/actors std/capsicum; do \
	  if [ -d "$$dir" ]; then \
